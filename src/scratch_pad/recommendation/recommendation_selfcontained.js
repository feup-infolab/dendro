...
var InformationElement = require('../../models/directory_structure/information_element.js').InformationElement;
var User = require('../../models/user.js').User;

var async = require('async');
var _ = require('../../public/js/underscorejs/underscore-min.js');
