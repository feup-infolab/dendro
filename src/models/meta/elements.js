...
Elements.schema = {
    sharedContent :
    {
        ...
        control : Elements.controls.input_box
...
Elements.dcterms =
{
    ...
    {
        type : DbConnection.string,
        control : Elements.controls.markdown_box
    },
    accessRights :
    {
        type : DbConnection.string,
    ...
    alternative :
    {
        ...
        control : Elements.controls.url_box
    },
    audience :
    {
        type : DbConnection.string,
    ...
    available :
    {
        ...
        control : Elements.controls.date_picker
    },
