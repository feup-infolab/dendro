...
const NoCache = rlequire("dendro", "src/kb/cache/caches/no_cache.js").NoCache;
        ...
        function (key, callback)
        {
            if (!Config.cache.active)
            {
                ...
                if (!isNull(dbConfig.cache))
                {
                    ...
                    Cache.caches[cacheId] = noCache;
                    Cache.cachesByGraphUri[graphUri] = noCache;
                    callback(null, noCache);
                }
                else
                {
                    callback(null, null);
