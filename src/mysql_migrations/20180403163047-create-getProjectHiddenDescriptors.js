...
module.exports = {
    up: (queryInterface, Sequelize) =>
        queryInterface.sequelize.query("DROP PROCEDURE IF EXISTS getProjectHiddenDescriptors;").then(() =>
            queryInterface.sequelize.query("CREATE PROCEDURE getProjectHiddenDescriptors (IN projectUri VARCHAR(255))" + " \n" +
                "BEGIN \n" +
    ...
    down: (queryInterface, Sequelize) =>
        queryInterface.sequelize.query("DROP PROCEDURE IF EXISTS getProjectHiddenDescriptors;")
};
