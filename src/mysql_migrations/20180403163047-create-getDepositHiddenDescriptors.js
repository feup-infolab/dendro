...
module.exports = {
    up: (queryInterface, Sequelize) =>
        queryInterface.sequelize.query("DROP PROCEDURE IF EXISTS getDepositHiddenDescriptors;").then(() =>
            queryInterface.sequelize.query("CREATE PROCEDURE getDepositHiddenDescriptors (IN projectUri VARCHAR(255))" + " \n" +
                "BEGIN \n" +
    ...
    down: (queryInterface, Sequelize) =>
        queryInterface.sequelize.query("DROP PROCEDURE IF EXISTS getDepositHiddenDescriptors;")
};
