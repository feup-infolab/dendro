...
module.exports = {
    up: (queryInterface, Sequelize) =>
        queryInterface.sequelize.query("DROP PROCEDURE IF EXISTS getDepositFavoriteDescriptors;").then(() =>
            queryInterface.sequelize.query("CREATE PROCEDURE getDepositFavoriteDescriptors (IN projectUri VARCHAR(255))" + " \n" +
                "BEGIN \n" +
    ...
    down: (queryInterface, Sequelize) =>
        queryInterface.sequelize.query("DROP PROCEDURE IF EXISTS getDepositFavoriteDescriptors;")
};
