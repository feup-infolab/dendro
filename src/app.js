...
async.series([
    ...
    function(callback)
    {
        ...
        app.post('/rating', async.apply(Permissions.require, [Permissions.role.system.user]), ratings.getDescriptorRating);
        app.post('/feedback', async.apply(Permissions.require, [Permissions.role.system.user]), ratings.getFeedback);
