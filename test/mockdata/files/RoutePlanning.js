...
module.exports = {
    md5: md5File.sync(Pathfinder.absPathInApp("/test/vehiclesimulation/RoutePlanning.pdf")),
    name: "RoutePlanning.pdf",
    extension: "pdf",
    location: Pathfinder.absPathInApp("/test/vehiclesimulation/RoutePlanning.pdf"),
    metadata: [{
        prefix: "nie",
