...
module.exports = {
    md5: md5File.sync(Pathfinder.absPathInApp("/test/vehiclesimulation/RegenerativeBraking.pdf")),
    name: "RegenerativeBraking.pdf",
    extension: "pdf",
    location: Pathfinder.absPathInApp("/test/vehiclesimulation/RegenerativeBraking.pdf"),
    metadata: [{
        prefix: "nie",
