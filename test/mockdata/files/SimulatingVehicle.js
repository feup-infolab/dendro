...
module.exports = {
    md5: md5File.sync(Pathfinder.absPathInApp("/test/vehiclesimulation/SimulatingVehicle.pdf")),
    name: "SimulatingVehicle.pdf",
    extension: "pdf",
    location: Pathfinder.absPathInApp("/test/vehiclesimulation/SimulatingVehicle.pdf"),
    metadata: [{
        prefix: "nie",
