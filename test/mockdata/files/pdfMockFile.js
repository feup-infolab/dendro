...
module.exports = {
    md5: md5File.sync(rlequire.absPathInApp("dendro", "test/mockdata/files/test_uploads/pdfTest.pdf")),
    name: "pdfTest.pdf",
    extension: "pdf",
    location: rlequire.absPathInApp("dendro", "test/mockdata/files/test_uploads/pdfTest.pdf"),
    metadata: [{
        prefix: "nie",
