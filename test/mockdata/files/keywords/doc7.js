...
module.exports = {
    md5: md5File.sync(rlequire.absPathInApp("dendro", "test/mockdata/keywords/SustainableChemistry/doc7.pdf")),
    name: "BusPerformance.pdf",
    extension: "pdf",
    location: rlequire.absPathInApp("dendro", "test/mockdata/keywords/SustainableChemistry/doc7.pdf"),
    metadata: [{
        prefix: "nie",
