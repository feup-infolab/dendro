...
module.exports = {
    md5: md5File.sync(Pathfinder.absPathInApp("/test/mockdata/keywords/vehiclesimulation/RoutePlanning.pdf")),
    name: "RoutePlanning.pdf",
    extension: "pdf",
    location: Pathfinder.absPathInApp("/test/mockdata/keywords/vehiclesimulation/RoutePlanning.pdf"),
    metadata: [{
        prefix: "nie",
