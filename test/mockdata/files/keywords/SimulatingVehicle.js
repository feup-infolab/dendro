...
module.exports = {
    md5: md5File.sync(rlequire.absPathInApp("dendro", "test/mockdata/keywords/vehiclesimulation/SimulatingVehicle.pdf")),
    name: "SimulatingVehicle.pdf",
    extension: "pdf",
    location: rlequire.absPathInApp("dendro", "test/mockdata/keywords/vehiclesimulation/SimulatingVehicle.pdf"),
    metadata: [{
        prefix: "nie",
