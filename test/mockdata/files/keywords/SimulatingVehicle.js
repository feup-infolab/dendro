...
module.exports = {
    md5: md5File.sync(Pathfinder.absPathInApp("/test/mockdata/keywords/vehiclesimulation/SimulatingVehicle.pdf")),
    name: "SimulatingVehicle.pdf",
    extension: "pdf",
    location: Pathfinder.absPathInApp("/test/mockdata/keywords/vehiclesimulation/SimulatingVehicle.pdf"),
    metadata: [{
        prefix: "nie",
