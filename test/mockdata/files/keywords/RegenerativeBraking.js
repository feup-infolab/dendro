...
module.exports = {
    md5: md5File.sync(rlequire.absPathInApp("dendro", "test/mockdata/keywords/vehiclesimulation/RegenerativeBraking.pdf")),
    name: "RegenerativeBraking.pdf",
    extension: "pdf",
    location: rlequire.absPathInApp("dendro", "test/mockdata/keywords/vehiclesimulation/RegenerativeBraking.pdf"),
    metadata: [{
        prefix: "nie",
