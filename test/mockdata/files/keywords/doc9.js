...
module.exports = {
    md5: md5File.sync(rlequire.absPathInApp("dendro", "test/mockdata/keywords/SustainableChemistry/doc9.pdf")),
    name: "BusPerformance.pdf",
    extension: "pdf",
    location: rlequire.absPathInApp("dendro", "test/mockdata/keywords/SustainableChemistry/doc9.pdf"),
    metadata: [{
        prefix: "nie",
