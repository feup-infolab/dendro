...
module.exports = {
    md5: md5File.sync(Pathfinder.absPathInApp("/test/mockdata/keywords/SustainableChemistry/doc12.pdf")),
    name: "BusPerformance.pdf",
    extension: "pdf",
    location: Pathfinder.absPathInApp("/test/mockdata/keywords/SustainableChemistry/doc12.pdf"),
    metadata: [{
        prefix: "nie",
