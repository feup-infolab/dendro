...
module.exports = {
    md5: md5File.sync(Pathfinder.absPathInApp("/test/mockdata/keywords/Photovoltaic/Electricalandopticalproperties.pdf")),
    name: "BusPerformance.pdf",
    extension: "pdf",
    location: Pathfinder.absPathInApp("/test/mockdata/keywords/Photovoltaic/Electricalandopticalproperties.pdf"),
    metadata: [{
        prefix: "nie",
