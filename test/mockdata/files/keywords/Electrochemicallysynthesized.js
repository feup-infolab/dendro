...
module.exports = {
    md5: md5File.sync(rlequire.absPathInApp("dendro", "test/mockdata/keywords/Photovoltaic/Electrochemicallysynthesized.pdf")),
    name: "BusPerformance.pdf",
    extension: "pdf",
    location: rlequire.absPathInApp("dendro", "test/mockdata/keywords/Photovoltaic/Electrochemicallysynthesized.pdf"),
    metadata: [{
        prefix: "nie",
