...
describe("Share a specific post tests", function () {
    ...
    describe("[POST] Share a specific post /posts/share", function () {
        ...
        it("[For demouser1, as the creator of all projects] Should share an existing ManualPost in a project created by demouser1", function (done) {
            done();
        });

        it("[For demouser1, as the creator of all projects] Should share an existing FileSystemPost in a project created by demouser1", function (done) {
            done();
        });

        it("[For demouser1, as the creator of all projects] Should share an existing MetadataPost in a project created by demouser1", function (done) {
            done();
        });

        it("[For demouser2, a collaborator in all projects] Should share an existing ManualPost in a project where demouser2 collaborates", function (done) {
            done();
        });
