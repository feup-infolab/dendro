...
const commentMockup = require(Pathfinder.absPathInTestsFolder("mockdata/social/comment.js"));
...
describe("Social Dendro add comment to post tests", function () {
    ...
    describe("[POST] /posts/comment", function () {
        ...
        it("Should return an error if the request type for this route is HTML", function (done) {
            userUtils.loginUser(demouser1.username, demouser1.password, function (err, agent) {
                postUtils.addCommentToPost(false, agent, demouser1PostURIs[0].uri, commentMockup.msg, function (err, res) {
        ...
        it("Should return an error if the post that the demouser wants to comment does not exist", function (done) {
            userUtils.loginUser(demouser1.username, demouser1.password, function (err, agent) {
                postUtils.addCommentToPost(true, agent, "invalidPostURI", commentMockup.msg, function (err, res) {
        ...
        it("Should return a success message if the post that the demouser2 wants to comment belongs to a project were the demouser2 is a collaborator or creator", function (done) {
