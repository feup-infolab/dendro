...
describe("Check if a user liked a post tests", function () {
    ...
    describe("[POST] [Public Project] Check if a user liked a Post /posts/like", function () {

        it("[For an unauthenticated user] Should give an unauthorized error", function (done) {
            done();
        });

        it("[For demouser1, as the creator of all projects] Should respond true to an existing post in a project created by demouser1 and liked by demouser1", function (done) {
            done();
        });

        it("[For demouser2, a collaborator in all projects] Should respond false to an existing post in a project where demouser2 collaborates but did not like the post", function (done) {
            done();
        });
