...
describe("Get a specific post information tests", function () {
    ...
    describe("[GET] Get a specific post information /posts/:uri", function () {
        ...
        it("[For demouser1, as the creator of all projects] Should give the post information from a post in a project created by demouser1", function (done) {
            done();
        });
        ...
        it("[For demouser1, as the creator of all projects] Should give a not found error from a post that does not exist", function (done) {
            done();
        });

        it("[For demouser2, a collaborator in all projects] Should give a not found error from a post that does not exist", function (done) {
            done();
        });

        it("[For demouser3, is not a creator or collaborator in any projects] Should give a not found error from a post that does not exist", function (done) {
            done();
        });
    });
