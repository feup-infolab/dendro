...
describe("[" + publicProject.handle + "]"   + "[INTERACTION TESTS] accept_descriptor_from_manual_list", function ()
{
    ...
    {
        it("Should give an error and not accept and register an interaction when a descriptor is added from the manual list while it was a user and project favorite when unauthenticated", function (done)
        {
        ...
        it("Should give an error and not accept and register an interaction when a descriptor is added from the manual list while it was a user and project favorite when logged in as demouser3, who is not a creator or collaborator of the project where the current resource belongs to", function (done)
        {
