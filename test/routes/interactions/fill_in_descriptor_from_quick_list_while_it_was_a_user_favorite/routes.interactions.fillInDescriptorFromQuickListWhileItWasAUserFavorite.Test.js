...
/*let bodyObj = {
    ...
    "rankingPosition": 2,
    "pageNumber": 0,
    "interactionType": "fill_in_descriptor_from_quick_list_while_it_was_a_user_favorite",
...
describe("[" + publicProject.handle + "]"   + "[INTERACTION TESTS] fill_in_descriptor_from_quick_list_while_it_was_a_user_favorite", function ()
{
            ...
            userUtils.loginUser(demouser1.username, demouser1.password, function (err, agent)
            {
                ...
                projectUtils.getProjectRootContent(true, agent, publicProject.handle, function (err, res)
                {
                    ...
                    descriptorUtils.getDescriptorsFromOntology(true, agent, dctermsPrefix, function (err, res) {
                        ...
                        demouser2InteractionObj.interactionType = "fill_in_descriptor_from_quick_list_while_it_was_a_user_favorite";
    ...
    describe("[POST] [Invalid Cases] /interactions/fill_in_descriptor_from_quick_list_while_it_was_a_user_favorite", function ()
    {
        it("Should give an error and not accept and register an interaction when a descriptor is filled in from the quick list while it was a user favorite when unauthenticated", function (done)
        {
            ...
            interactionsUtils.fillInDescriptorFromQuickListWhileItWasAUserFavorite(true, agent, demouser1InteractionObj, function (err, res)
            {
                should.exist(err);
        ...
        it("Should give an error and not accept and register an interaction when a descriptor is filled in from the quick list while it was a user favorite when logged in as demouser3, who is not a creator or collaborator of the project where the current resource belongs to", function (done)
        {
        ...
        it("Should give an error and not accept and register an interaction if the interaction type field is invalid, even if logged in as demouser1 (creator of the project)", function (done)
        {
            userUtils.loginUser(demouser1.username, demouser1.password, function (err, agent)
            {
                ...
                interactionsUtils.fillInDescriptorFromQuickListWhileItWasAUserFavorite(true, agent, copyOfDemouser1InteractionObj, function (err, res)
                {
                    should.exist(err);
                    should.exist(res);
    ...
    describe("[POST] [Valid Cases] /interactions/fill_in_descriptor_from_quick_list_while_it_was_a_user_favorite", function ()
    {
        it("Should accept and register an interaction when a descriptor is filled in from the quick list while it was a user favorite logged in as demouser1 (the creator of the current project)", function (done)
        {
            userUtils.loginUser(demouser1.username, demouser1.password, function (err, agent)
            {
        ...
        it("Should accept and register an interaction when a descriptor is filled in from the quick list while it was a user favorite logged in as demouser2 (a collaborator on the current project)", function (done)
        {
            userUtils.loginUser(demouser2.username, demouser2.password, function (err, agent)
            {
                userUtils.getUserInfo(demouser2.username, true, agent, function (err, res)
                {
                    ...
                    interactionsUtils.fillInDescriptorFromQuickListWhileItWasAUserFavorite(true, agent, demouser2InteractionObj, function (err, res)
                    {
                        should.equal(err, null);
                        res.statusCode.should.equal(200);
                        //SHOULD ALSO BE IN THE MYSQL DATABASE
