                        ...
                        interactionsUtils.getNumberOfInteractionsInDB(function (err, info)
                        {
                            ...
                            interactionsUtils.getLatestInteractionInDB(function (err, info)
                            {
                                ...
                                itemUtils.getItemMetadataRecommendationsByItemUri(true, agent, demouser1InteractionObj.recommendedFor, function (err, res)
                                {
                                    ...
                                    res.body.descriptors[demouser1DescriptorIndex].recommendation_types.project_hidden.should.equal(true);
                        ...
                        interactionsUtils.getNumberOfInteractionsInDB(function (err, info)
                        {
                            ...
                            interactionsUtils.getLatestInteractionInDB(function (err, info)
                            {
                                ...
                                itemUtils.getItemMetadataRecommendationsByItemUri(true, agent, demouser1InteractionObj.recommendedFor, function (err, res)
                                {
                                    ...
                                    demouser2DescriptorIndex.should.not.equal(demouser1DescriptorIndex);
                                    expect(res.body.descriptors.length).to.be.above(demouser2DescriptorIndex);
                                    res.body.descriptors[demouser2DescriptorIndex].recommendation_types.project_hidden.should.equal(true);
                                    done();
                                });
                            });
                        });
