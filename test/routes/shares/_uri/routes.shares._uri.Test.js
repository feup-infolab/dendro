...
describe("Get a specific share information tests", function () {
    ...
    describe("[GET] Get a specific share information /shares/:uri", function () {
        ...
        it("[For demouser1, as the creator of all projects] Should give the share information from a share in a project created by demouser1", function (done) {
            done();
        });

        it("[For demouser2, a collaborator in all projects] Should give the share information from a share in a project where demouser2 collaborates)", function (done) {
            done();
        });
