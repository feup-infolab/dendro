...
describe('Private project testFolder2 level recommendation_ontologies tests', function ()
{
    ...
    describe(privateProject.handle + '/data/' + testFolder2.name + '?recommendation_ontologies', function ()
    {
        it('[HTML] should refuse the request if "application/json" Accept header is absent', function (done)
        {
            userUtils.loginUser(demouser1.username, demouser1.password, function (err, agent)
            {
                itemUtils.getItemRecommendationOntologies(false, agent, privateProject.handle, testFolder2.name, function (err, res)
                {
        ...
        it('[JSON] should forbid ontology recommendation requests in project ' + privateProject.handle + ' if no user is authenticated.', function (done)
        {
            ...
            itemUtils.getItemRecommendationOntologies(true, agent, privateProject.handle, testFolder2.name, function (err, res)
            {
