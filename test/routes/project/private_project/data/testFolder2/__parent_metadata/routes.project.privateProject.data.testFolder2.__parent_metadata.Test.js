...
describe("Private project testFolder2 level parent_metadata tests", function ()
{
    ...
    describe("/project/" + privateProject.handle + "/data/" + testFolder2.name + "?parent_metadata (private project)", function ()
    {
        /**
        ...
        it("[HTML] should refuse request if Accept application/json was not specified", function (done)
        {
            ...
            {
                itemUtils.getItemParentMetadata(false, agent, privateProject.handle, testFolder2.name, function (err, res)
                {
        ...
        it("[JSON] should fetch the parent_metadata of the " + privateProject.handle + "/data/" + testFolder2.name + " resource, authenticated as " + demouser1.username + " (creator)", function (done)
        {
            userUtils.loginUser(demouser1.username, demouser1.password, function (err, agent)
            {
                itemUtils.getItemParentMetadata(true, agent, privateProject.handle, testFolder2.name, function (err, res)
        ...
        it("[JSON] should refuse to fetch the parent_metadata of the " + privateProject.handle + "/data/" + testFolder2.name + " resource, authenticated as " + demouser3.username + " (not creator nor contributor)", function (done)
        {
        ...
        it("[JSON] should fetch the parent_metadata of the " + privateProject.handle + "/data/" + testFolder2.name + " resource, authenticated as " + demouser2.username + " (contributor)", function (done)
        {
    ...
    describe(privateProject.handle + "/data/" + testFolder2.name + "?parent_metadata (non-existant project)", function ()
    {
        it("[HTML] should refuse request if Accept application/json was not specified", function (done)
        {
            userUtils.loginUser(demouser1.username, demouser1.password, function (err, agent)
