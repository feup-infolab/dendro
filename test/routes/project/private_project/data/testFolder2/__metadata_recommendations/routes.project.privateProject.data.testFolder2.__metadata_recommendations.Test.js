...
describe("Private project testFolder2 level metadata_recommendations tests", function () {
    ...
    describe(privateProject.handle + "/data/" + testFolder2.name +"?metadata_recommendations", function ()
    {
        it('[HTML] should refuse the request if "application/json" Accept header is absent', function (done)
        {
            userUtils.loginUser(demouser1.username, demouser1.password, function (err, agent) {
                itemUtils.getItemMetadataRecommendations(false, agent, privateProject.handle, testFolder2.name, function (err, res) {
        ...
        it('[JSON] should forbid requests for recommendations in project '+ privateProject.handle +' if no user is authenticated.', function (done)
        {
            ...
            itemUtils.getItemMetadataRecommendations(true, agent, privateProject.handle, testFolder2.name, function (err, res) {
