...
describe("Private project testFolder1 level undelete tests", function ()
{
    ...
    describe("[POST] [Private PROJECT] /project/" + privateProject.handle + "/data/:foldername?undelete", function ()
    {
        ...
        it("Should give an error when the request type for this route is HTML", function (done)
        {
            ...
            {
                itemUtils.undeleteItem(false, agent, privateProject.handle, testFolder1.name, function (err, res)
                {
        ...
        it("Should give an error when the user is not authenticated", function (done)
        {
            ...
            itemUtils.undeleteItem(true, agent, privateProject.handle, testFolder1.name, function (err, res)
            {
