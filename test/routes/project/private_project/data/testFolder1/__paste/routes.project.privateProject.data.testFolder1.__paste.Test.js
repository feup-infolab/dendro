...
describe('Private project testFolder1 level ?paste', function ()
{
    ...
    describe('[POST] [FOLDER LEVEL] [PRIVATE PROJECT] /project/' + privateProject.handle + '/data/:foldername?paste', function ()
    {
