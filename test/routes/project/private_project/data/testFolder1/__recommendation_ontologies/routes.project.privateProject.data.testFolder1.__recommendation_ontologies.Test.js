...
describe("Private project testFolder1 level recommendation_ontologies tests", function () {
    ...
    describe(privateProject.handle + "/data/" + testFolder1.name + "?recommendation_ontologies", function ()
    {
        it('[HTML] should refuse the request if "application/json" Accept header is absent', function (done)
        {
            userUtils.loginUser(demouser1.username, demouser1.password, function (err, agent) {
                itemUtils.getItemRecommendationOntologies(false, agent, privateProject.handle, testFolder1.name, function (err, res) {
