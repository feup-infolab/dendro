...
describe("Public project testFolder1 level undelete tests", function ()
{
    ...
    describe("[POST] [PUBLIC PROJECT] /project/" + publicProject.handle + "/data/:foldername?undelete", function ()
    {
        ...
        it("Should give an error when the request type for this route is HTML", function (done)
        {
            ...
            {
                itemUtils.undeleteItem(false, agent, publicProject.handle, testFolder1.name, function (err, res)
                {
        ...
        it("Should give an error when the user is not authenticated", function (done)
        {
            ...
            itemUtils.undeleteItem(true, agent, publicProject.handle, testFolder1.name, function (err, res)
            {
