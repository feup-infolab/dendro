...
describe('Public project testFolder2 level metadata&deep tests', function ()
{
    ...
    describe('/project/' + publicProject.handle + '/data/' + testFolder2.name + '?metadata&deep (public project)', function ()
    {
        /**
        ...
        it('[HTML] should refuse request if Accept application/json was not specified', function (done)
        {
            ...
            {
                itemUtils.getItemMetadataDeep(false, agent, publicProject.handle, testFolder2.name, function (err, res)
                {
        ...
        it('[JSON] should fetch metadata recursively of the ' + publicProject.handle + '/data/' + testFolder2.name + ' resource, authenticated as ' + demouser1.username + ' (creator)', function (done)
        {
            userUtils.loginUser(demouser1.username, demouser1.password, function (err, agent)
            {
                itemUtils.getItemMetadataDeep(true, agent, publicProject.handle, testFolder2.name, function (err, res)
        ...
        it('[JSON] should fetch metadata recursively of the ' + publicProject.handle + '/data/' + testFolder2.name + ' resource, authenticated as ' + demouser3.username + ' (not creator nor contributor)', function (done)
        {
        ...
        it('[JSON] should fetch metadata recursively of the ' + publicProject.handle + '/data/' + testFolder2.name + ' resource, authenticated as ' + demouser2.username + ' (contributor)', function (done)
        {
    ...
    describe(publicProject.handle + '/data/' + testFolder2.name + '?metadata&deep (non-existant project)', function ()
    {
        it('[HTML] should refuse request if Accept application/json was not specified', function (done)
        {
            userUtils.loginUser(demouser1.username, demouser1.password, function (err, agent)
