...
describe("Metadata only project testFolder2 level restore_metadata_version", function ()
{
    ...
    describe("[POST] [METADATA ONLY PROJECT] /project/" + metadataProject.handle + "/data/foldername?restore_metadata_version", function ()
    {
        ...
        it("Should give an error of the request type for this route is html", function (done)
        {
            ...
            {
                itemUtils.itemRestoreMetadataVersion(false, agent, metadataProject.handle, testFolder2.name, 0, function (err, res)
                {
        ...
        it("Should give an error if the user is unauthenticated", function (done)
        {
            ...
            itemUtils.itemRestoreMetadataVersion(true, agent, metadataProject.handle, testFolder2.name, 0, function (err, res)
            {
