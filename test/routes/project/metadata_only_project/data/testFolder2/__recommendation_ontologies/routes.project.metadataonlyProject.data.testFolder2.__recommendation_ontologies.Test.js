...
describe("Metadata only project testFolder2 level recommendation_ontologies tests", function ()
{
    ...
    describe(metadataProject.handle + "/data/" + testFolder2.name + "?recommendation_ontologies", function ()
    {
        it("[HTML] should refuse the request if \"application/json\" Accept header is absent", function (done)
        {
            userUtils.loginUser(demouser1.username, demouser1.password, function (err, agent)
            {
                itemUtils.getItemRecommendationOntologies(false, agent, metadataProject.handle, testFolder2.name, function (err, res)
                {
